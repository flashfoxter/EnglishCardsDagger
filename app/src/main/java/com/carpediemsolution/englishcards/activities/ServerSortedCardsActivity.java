    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case (R.id.culture_art): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_CULTURE_ART);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_CULTURE_ART);
                break;
            }
            case (R.id.modern_technologies): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_MODERN_TECHNOLOGIES);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_MODERN_TECHNOLOGIES);
                break;
            }
            case (R.id.society_politics): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_SOCIETY_POLITICS);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_SOCIETY_POLITICS);
                break;
            }
            case (R.id.adventure_travel): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_ADVENTURE_TRAVEL);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_ADVENTURE_TRAVEL);
                break;
            }
            case (R.id.nature_weather): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_NATURE_WEATHER);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_NATURE_WEATHER);
                break;
            }
            case (R.id.education_profession): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_EDUCATION_PROFESSION);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_EDUCATION_PROFESSION);
                break;
            }
            case (R.id.appearance_character): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_APPEARANCE_CHARACTER);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_APPEARANCE_CHARACTER);
                break;
            }
            case (R.id.clothes_fashion): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_CLOTHES_FASHION);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_CLOTHES_FASHION);
                break;
            }
            case (R.id.sport): {
                cardsAdapter.clear();
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_SPORT);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_SPORT);
                break;
            }
            case (R.id.family_relationship): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_FAMILY_RELATIONSHIP);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_FAMILY_RELATIONSHIP);
                break;
            }
            case (R.id.order_of_day): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_THE_ORDER_OF_DAY);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_THE_ORDER_OF_DAY);
                break;
            }
            case (R.id.hobbies_free_time): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_HOBBIES_FREE_TIME);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_HOBBIES_FREE_TIME);
                break;
            }
            case (R.id.customs_traditions): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_CUSTOMS_TRADITIONS);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_CUSTOMS_TRADITIONS);
                break;
            }
            case (R.id.shopping): {
                cardsAdapter.clear();
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_SHOPPING);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_SHOPPING);
                break;
            }
            case (R.id.food_drinks): {
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(ServerSortedCardsActivity.this, 3);
                cardsRecyclerView.setLayoutManager(gridLayoutManager);
                downloadAllCardsFirstTime(DBSchema.CardTable.Themes.THEME_FOOD_DRINKS);
                addOnScrollListener(cardsRecyclerView, gridLayoutManager, DBSchema.CardTable.Themes.THEME_FOOD_DRINKS);
                break;
            }
            default:break;
        }
